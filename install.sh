...
#
#   curl https://github.com/jetpeter/dotfiles/raw/master/install.sh | sh
#
# or:
#
#   ~/.dotfiles/install.sh
...
bindir=$HOME/bin
gitbase=git://github.com/jetpeter/dotfiles.git
tarball=http://github.com/jetpeter/dotfiles/tarball/master
